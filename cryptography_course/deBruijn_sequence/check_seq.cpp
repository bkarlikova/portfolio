...
int main()
{
    ...
    statusOK = read_seq(fp, sequence);
    if (statusOK)
        statusOK = check_seq(sequence, states);
    else
    ...
    {
        printf("Sequence contains 10003 digits\n");
...
{
    // read a De Bruijn sequence from file and store in seq
    // returns 1 if sequence contains 10003 digits 0 otherwise
